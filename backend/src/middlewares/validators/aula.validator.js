// src/middlewares/validators/aula.validator.js
import { body, validationResult } from 'express-validator';

// Middleware para validar a criação de uma aula
export const validateCreateAula = [
  body('titulo')
    .trim()
...
// Middleware para validar a atualização de uma aula
export const validateUpdateAula = [
  body('titulo')
    .optional()
    .trim()
    .isLength({ min: 3, max: 100 }).withMessage('O título deve ter entre 3 e 100 caracteres.'),
